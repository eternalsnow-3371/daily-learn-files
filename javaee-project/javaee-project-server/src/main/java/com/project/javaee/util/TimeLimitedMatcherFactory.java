 ...
 *
 * @author from https://www.exratione.com/2017/06/preventing-unbounded-regular-expression-operations-in-java/
 */
public class TimeLimitedMatcherFactory {
    ...
    private static final long RE_TIMEOUT_MILLISECONDS = 2000L;
    ...
    public static Matcher matcher(
        ...
        return matcher(pattern, charSequence, RE_TIMEOUT_MILLISECONDS);
    }
